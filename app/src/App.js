...
class  App extends React.Component {
  ...
  componentDidMount(){
    axios.get("http://54.236.54.4:8080/api/")
    .then((res)=>{
      this.setState({
        users:res.data,
        id:0,
  ...
  submit(evenet,id){
    ...
    if(id===0){
      axios.post("http://54.236.54.4:8080/api/",{
      ...
      axios.put("http://54.236.54.4:8080/api/",{
        id:id,
        EmployeeName:this.state.EmployeeName,
        EmployeeTeam:this.state.EmployeeTeam,
        EmployeePhoneNumber:this.state.EmployeePhoneNumber
  ...
  delete(id){
    axios.delete("http://54.236.54.4:8080/api/"+id)
    .then(()=>{
      this.componentDidMount();
    })
  }
  edit(id){
    axios.get("http://54.236.54.4:8080/api/"+id)
    .then((res)=>{
      this.setState({
        id:res.data.id,
